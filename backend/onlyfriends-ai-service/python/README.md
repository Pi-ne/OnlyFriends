...
It keeps the same response envelope and endpoint paths as the Java mock service, and provides three AI capabilities behind a unified REST API consumed by the activity service.
