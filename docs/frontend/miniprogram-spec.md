...
| Tab | 页面路径 | 作用 |
|---|---|---|
| 发现 | `/pages/home/index/index` | 活动推荐、搜索、筛选、附近活动入口 |
| 发起 | `/pages/activity/create/index` | 创建活动、AI 策划、草稿保存 |
| 小队 | `/pages/team/list/index` | 兴趣小队列表、我的小队、创建小队 |
| 消息 | `/pages/im/conversations/index` | 私聊、群聊、系统活动通知入口 |
| 我的 | `/pages/profile/index/index` | 个人资料、我的活动、商家申请、设置 |
